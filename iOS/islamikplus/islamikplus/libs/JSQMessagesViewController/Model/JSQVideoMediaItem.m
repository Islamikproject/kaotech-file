...
- (UIView *)mediaView
{
    ...
    if (self.cachedVideoImageView == nil) {
        ...
        UIImageView *sumbimageView = [[UIImageView alloc] initWithImage:playIcon];
        sumbimageView.backgroundColor = [UIColor blackColor];
        sumbimageView.frame = CGRectMake(0.0f, 0.0f, size.width, size.height);
        sumbimageView.contentMode = UIViewContentModeCenter;
        sumbimageView.clipsToBounds = YES;
        [JSQMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:sumbimageView isOutgoing:self.appliesMediaViewMaskAsOutgoing];
        ...
        [sumbimageView addSubview:imageView];
        self.cachedVideoImageView = sumbimageView;
    }
