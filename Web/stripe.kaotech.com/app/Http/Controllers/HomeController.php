...
class HomeController extends Controller
{
    ...
    {
      // init Parse
      $app_id = 'b0484b2d-2135-4a2d-a924-b916750cf909';
      $rest_key = 'b0bae137-c18c-4a73-aceb-51726922bc09';
      $master_key = 'b054d1ea-0128-4a27-b107-59b61b4db409';
      ParseClient::initialize($app_id, $rest_key, $master_key);
      ParseClient::setServerURL('https://parseapps.brainyapps.tk:20009/','parse');
    ...
    public function login(Request $request){
      ...
      if (array_key_exists('scope', $input) && array_key_exists('code', $input)) {
        $code = $input['code'];
        $post = 'grant_type='.$this->STRIPE_GRANT_TYPE.
          ...
          if ($response === false) {
            ...
            if (array_key_exists("error", $strip_res)) {
