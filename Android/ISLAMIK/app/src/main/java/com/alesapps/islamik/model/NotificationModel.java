...
import com.alesapps.islamik.ui.activity.MainActivity;
...
public class NotificationModel {
		...
		notificationObj.saveInBackground(new SaveCallback() {
			...
			public void done(ParseException e) {
				if (ParseErrorHandler.handle(e) == null) {
					int type = NotificationModel.TYPE_BOOK;
					JSONObject object = new JSONObject();
					String message = String.format(IslamikApp.getContext().getString(R.string.msg_notification_accepted), UserModel.GetFullName(ParseUser.getCurrentUser()));
					if (state == NotificationModel.STATE_REJECT)
						message = String.format(IslamikApp.getContext().getString(R.string.msg_notification_declined), UserModel.GetFullName(ParseUser.getCurrentUser()), UserModel.GetFullName(notificationObj.getParseUser(ParseConstants.KEY_OWNER)));
					PushNoti.sendPush(type, notificationObj.getParseUser(ParseConstants.KEY_OWNER), message, object.toString(), null);
				} else {
					if (listener != null)
	...
	public static void showNotification(final int type, final String message) {
		...
		Context context = IslamikApp.getContext();

		NotificationCompat.Builder notiBuilder = new NotificationCompat.Builder(context)
				.setSmallIcon(R.drawable.app_icon)
				.setContentTitle(IslamikApp.getContext().getString(R.string.app_name))
